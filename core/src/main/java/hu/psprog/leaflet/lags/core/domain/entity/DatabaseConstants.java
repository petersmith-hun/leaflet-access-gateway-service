...
public final class DatabaseConstants {
    ...
    static final String TABLE_ROLES = TABLE_PREFIX + "roles";
    ...
    static final String COLUMN_LOCAL_DEFAULT = "local_default";
    static final String COLUMN_EXTERNAL_DEFAULT = "external_default";
    ...
    static final String UK_ROLE_NAME = "uk_role_name";
    ...
    static final String FK_NM_ROLE_PERMISSIONS_ROLE_ID = "fk_nm_role_permissions_role_id";
    static final String FK_NM_ROLE_PERMISSIONS_PERMISSION_ID = "fk_nm_role_permissions_permission_id";
